...
##tools_home = os.environ['TOOLS']
##kallisto_prg = os.path.realpath( os.path.join(tools_home,'external_libs','kallisto') )
KALLISTO = 'KALLISTO'
...
class ExpressionScript( ParentScript.ParentScript ):
    ...
    def func_update_arguments(self, arg_raw ):
        ...
        * return  : Updated Arguments
        ...
        arg_raw.add_argument( "--right_fq", required=False ,default="", help ="Right read fastq" )
    ...
    def func_make_commands( self, args_parsed, cur_pipeline ):
        ...
        cur_pipeline.func_mkdirs( [ KALLISTO ] )
